...
<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="btnShow" >
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="btnSheel">
      <div class="discounts-left">
        <div class="activity">
          <span class="content-tag">
            <span class="mini-tag" :class="supportClasses[info.supports[0].type]">{{info.supports[0].name}}</span>
          </span>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showShop">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="btnShow">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="showSheet">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="btnSheel">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
