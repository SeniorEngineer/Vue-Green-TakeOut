    ...
    <div class="shopcart">
      ...
      <div class="shopcart-list" v-show="listShow">
        <div class="list-header">
          ...
          <span class="empty" v-if="totalCount" @click="clearCart">清空</span>
        </div>
        <div class="list-content">
          <ul>
            <li class="food" v-for="(item,index) in cartGood" :key="index">
              <span class="name">{{item.name}}</span>
              <div class="price">
                <span>￥{{item.price}}</span>
              </div>
              <div class="cartcontrol-wrapper">
               <CartContol :good="item"/>
              </div>
            </li>
          </ul>
        </div>
...
import CartContol from '../CartContol/CartContol'
    ...
    listShow () {
      ...
      if (this.isShow) {
        this.$nextTick(() => {
          if (!this.scroll) {
            // eslint-disable-next-line vue/no-side-effects-in-computed-properties
            this.scroll = new BCscroll('.list-content', {
              click: true
            })
          } else {
