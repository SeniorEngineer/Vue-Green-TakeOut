<!--图片点击详情组件 -->
<template>
  <div class="food" v-if="ishow">
    <div class="food-content">
      <div class="image-header">
        <img
          v-lazy="good.image"
        >
        <p class="foodpanel-desc">{{good.info}}</p>
        <div class="back">
    ...
    <div data-v-fd4d2fe2 class="food-cover" @click="toggleShow"></div>
  </div>
</template>

<script>
import cartcontrol from '../CartContol/CartContol'
export default {
  components: {
    cartcontrol
  },
